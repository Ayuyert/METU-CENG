...
public abstract class CengTreeNode
{
    ...
    // Extra Functions
    public abstract void addBookHelper(CengBook kitap, CengTree tree);

    public abstract void PrintHelper2(int tab, int max);

    public abstract void SearchHelper(int BookNum);
}
